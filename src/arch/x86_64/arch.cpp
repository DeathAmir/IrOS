...
void pic_init(){
    io_out8(0x20,0x11);io_out8(0xA0,0x11);io_out8(0x21,0x20);io_out8(0xA1,0x28);io_out8(0x21,4);io_out8(0xA1,2);io_out8(0x21,1);io_out8(0xA1,1);
    io_out8(0x21,0xF8);io_out8(0xA1,0xEF);
}
